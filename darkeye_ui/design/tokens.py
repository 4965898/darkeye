...
BLUE_TOKENS = ThemeTokens(
    ...
    color_bg="#e3f2fd",
    color_bg_input="#bbdefb",
    color_bg_page="#90caf9",
    color_border="#64b5f6",
    color_border_focus="#1565c0",
    color_text="#0d47a1",
    color_text_inverse="#ffffff",
    color_text_placeholder="#1976d2",
    color_text_disabled="#546e7a",
    color_success="#2e7d32",
    color_warning="#e65100",
    color_error="#c62828",
    color_info="#0277bd",
    color_icon="#0d47a1",
    color_icon_disabled="#546e7a",
    radius_md="8px",
    font_family_base="Microsoft YaHei",
    font_size_base="12px",
    border_width="2px",
...
PURPLE_TOKENS = ThemeTokens(
    ...
    color_primary_hover="#4a148c",
    color_bg="#f3e5f5",
    color_bg_input="#e1bee7",
    color_bg_page="#ce93d8",
    color_border="#ba68c8",
    color_border_focus="#7b1fa2",
    color_text="#4a148c",
    color_text_inverse="#ffffff",
    color_text_placeholder="#9c27b0",
    color_text_disabled="#5c6bc0",
    color_success="#2e7d32",
    color_warning="#e65100",
    color_error="#c62828",
    color_info="#1565c0",
    color_icon="#4a148c",
    color_icon_disabled="#5c6bc0",
    radius_md="8px",
    font_family_base="Microsoft YaHei",
    font_size_base="12px",
    border_width="2px",
